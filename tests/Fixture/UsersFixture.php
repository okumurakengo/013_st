...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        'id' => ['type' => 'integer', 'length' => 11, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => 'ユーザーID', 'precision' => null, 'autoIncrement' => null],
        ...
        'role' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '権限', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'display_order' => 1,
            'select_flg' => 1,
            'created' => '2017-02-04 20:10:08',
            'modified' => '2017-02-04 20:10:08'
        ],
    ];
}
