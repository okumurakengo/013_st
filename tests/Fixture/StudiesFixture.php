...
class StudiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'small_chapter_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '小分類ID', 'precision' => null, 'autoIncrement' => null],
        'status_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => 'ステータスID', 'precision' => null, 'autoIncrement' => null],
        'content' => ['type' => 'string', 'length' => 500, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '要約', 'precision' => null, 'fixed' => null],
        'memo' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'メモ', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'display_order' => 1,
            'select_flg' => 1,
            'created' => '2017-02-19 16:42:00',
            'modified' => '2017-02-19 16:42:00'
        ],
    ];
}
