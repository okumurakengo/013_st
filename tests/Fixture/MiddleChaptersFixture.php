...
/**
 * MiddleChaptersFixture
 *
 */
class MiddleChaptersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'big_chapter_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '大分類ID', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'display_order' => 1,
            'select_flg' => 1,
            'created' => '2017-02-04 20:10:32',
            'modified' => '2017-02-04 20:10:32'
        ],
    ];
}
